...
#                                                       ---------
# version 3-Mar-2022 modified to work with RemoteUI
...
#state machine that just pushes bytes to the 8 pins
